...
| Q2 | Fuzz iterations, zero crashes (record_codec / wal_reader / btree_ops / dag_ops) | ≥ 10,000,000 each | ✅ **all 4 targets at full 10M, 0 crashes** (`record_codec` 88s · `wal_reader` 408s · `btree_ops` 1043s · `dag_ops` 8143s) |
